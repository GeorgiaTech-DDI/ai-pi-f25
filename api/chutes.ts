...
function createPayload(question: string, contextStr: string, conversationHistory: string = "") {
  const systemMessage = `You are a helpful AI PI (artificial intelligent prototyping instructor) that answers questions about the Invention Studio at Georgia Tech based on the provided context.
